...
class SeederCategorias extends Seeder
{
    ...
    /* $file = public_path().'/images/categorias'; */
    ...
    public function run()
    {
        ...
        $categorias->imagen = public_path().'/images/categorias/futbol2.jpg';
        $categorias->save();
        ...
        $categorias->imagen = asset('images/categorias/boxeo.jpg');
        $categorias->save();
        ...
        $categorias->imagen = url('/public/images/categorias/tenis2.png');
        $categorias->save();
        ...
        $categorias->imagen = url('/public/images/categorias/basquet2.jpg');
        $categorias->save();
        ...
        $categorias->imagen = url('/public/images/categorias/hockey2.jpg');
        $categorias->save();
        ...
        $categorias->imagen = url('/public/images/categorias/jjoo.jpg');
        $categorias->save();
    }
}
